package com.clinton.mvvmandrioid.ui.theme.screen.intent
...
fun intentscreen(navController:NavHostController) {
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                var emailIntent =
                    Intent(Intent.ACTION_SENDTO,Uri.fromParts("mailto", "ochiengclinton95@gmail.com", null))

                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Subject")

                emailIntent.putExtra(Intent.EXTRA_TEXT, "Body")

                context.startActivity(Intent.createChooser(emailIntent, "send emaill...."))
            },
            colors = ButtonDefaults.buttonColors(Color.Blue),
            shape = RoundedCornerShape(16.dp),
            modifier = Modifier.fillMaxWidth()
